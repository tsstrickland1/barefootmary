  ...
  return (
    <>
      ...
      <section className="px-12 py-20 border-b border-border max-md:px-6 max-md:py-12">
        <div className={`bg-bg-surface border border-border p-12 grid grid-cols-1 gap-12 items-stretch relative overflow-hidden max-md:p-6${season.image_url ? " md:grid-cols-2" : ""}`}>
